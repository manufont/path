...
const layers = [
  ...
  },
  {
    ...
    layout: { visibility: "visible" },
    metadata: {},
    paint: { "fill-antialias": false, "fill-color": "rgba(224, 232, 201, 1)", "fill-opacity": 0.3 },
    source: "openmaptiles",
    "source-layer": "landcover",
    type: "fill",
  },
  ...
  },
  {
    ...
    layout: { visibility: "visible" },
    metadata: {},
    paint: { "fill-antialias": false, "fill-color": "#f2e9ac", "fill-opacity": 1 },
    source: "openmaptiles",
    "source-layer": "landcover",
    type: "fill",
  },
  ...
  },
  {
    ...
    layout: { visibility: "visible" },
    metadata: {},
    paint: { "fill-antialias": true, "fill-color": "rgba(246, 241, 229, 1)" },
    source: "openmaptiles",
    "source-layer": "transportation",
    type: "fill",
  },
  ...
  },
  {
    ...
    layout: { visibility: "visible" },
    metadata: {},
    paint: { "fill-antialias": true, "fill-color": "rgba(246, 241, 229, 0.6)" },
    source: "openmaptiles",
    "source-layer": "transportation",
    type: "fill",
  },
  ...
  {
    filter: ["all", ["==", "admin_level", 2], ["!has", "claimed_by"], ["==", "disputed", 0]],
    id: "boundary_2_z0-4",
    layout: { "line-cap": "round", "line-join": "round", visibility: "visible" },
    maxzoom: 5,
    metadata: {},
  ...
  {
    filter: ["all", ["==", "admin_level", 2], ["!has", "claimed_by"], ["==", "disputed", 1]],
  ...
  },
  {
    ...
    paint: {
      "line-color": {
        stops: [
          [5, "rgba(120, 120, 120, 1)"],
          [12, "rgba(153, 153, 153, 1)"],
        ],
      },
      "line-opacity": 1,
      "line-width": {
